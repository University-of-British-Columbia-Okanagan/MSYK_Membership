...
export async function loader({
  ...
  const registrations = await getUserWorkshopRegistrationsByWorkshopId(workshopId);
...
// // New component to handle the result dropdown with confirmation.
// function ResultDropdownWithConfirm({
//   reg,
// }: {
//   reg: LoaderData["registrations"][number];
// }) {
//   const [selectedValue, setSelectedValue] = useState(reg.result);
...
//     formData.append("action", "updateRegistrationResult");
//     formData.append("registrationId", reg.id.toString());
//     formData.append("newResult", selectedValue);
//     await fetch("/dashboard/admin", { method: "POST", body: formData });
...
//           confirmDescription={`Are you sure you want to change the result to "${selectedValue}"?`}
...
//   // Determine workshop name from first registration (if available)
//   const workshopName =
//     registrations.length > 0 && registrations[0].workshop
//       ? registrations[0].workshop.name
//       : "This Workshop";
...
//       render: (reg) => {
//         if (reg.workshop && reg.workshop.type.toLowerCase() === "orientation") {
//           return <ResultDropdownWithConfirm reg={reg} />;
//         }
//         return reg.result || "Pending";
//       },
//     },
