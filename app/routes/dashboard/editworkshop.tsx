...
export async function action({ request, params }: { request: Request; params: { workshopId: string } }) {
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Workshop Name" {...field} className="w-full lg:w-[500px]" />
                  </FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Workshop Description" {...field} className="w-full" rows={5} />
                  </FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Workshop Location" {...field} className="w-full" />
                  </FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input type="number" placeholder="Capacity" {...field} className="w-full" />
                  </FormControl>
