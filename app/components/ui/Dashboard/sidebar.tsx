  ...
  return (
    <Sidebar className="h-screen w-64 bg-white shadow-lg flex flex-col">
      ...
      <SidebarHeader className="flex justify-center p-4">
        <img src="public/images/Makerspace Horizontal Text Logo Colour-01.avif" alt="Makerspace YK" className="h-30" />
      </SidebarHeader>
      ...
      <SidebarContent className="flex flex-col gap-3 px-4 flex-grow space-y-4">
        <SidebarGroup className="space-y-10">
          ...
          <Link to="/dashboard/events" className="flex items-center gap-2 text-gray-700 hover:text-blue-500">
            <Calendar className="w-5 h-5" />
            Events
          </Link>
          <Link to="/dashboard/membership" className="flex items-center gap-2 text-gray-700 hover:text-blue-500">
