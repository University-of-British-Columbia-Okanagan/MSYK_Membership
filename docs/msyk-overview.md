...
- **Findings**:
  ...
  - Users can access add a workshop route by going into the route /addworkshop :skull-emoji:
  - Users can access edit a workshop route by going into the route /editworkshop/workshopId :skull-emoji:
